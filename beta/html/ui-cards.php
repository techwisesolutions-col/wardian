                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active">
                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="ui-cards.html"><i class="las la-credit-card"></i>Cards</a></li>
               ...
               <div class="row">
                  <div class="col-sm-3">
                     <div class="card iq-mb-3">
                        <img src="images/page-img/07.jpg" class="card-img-top" alt="#">
                        <div class="card-body">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-4">
                     <div class="card bg-dark text-white iq-mb-3">
                        <img src="images/page-img/07.jpg" class="card-img" alt="#">
                  ...
                  <div class="col-lg-6">
                     <div class="card iq-mb-3">
                        <div class="row no-gutters flex-row-reverse">
                           <div class="col-md-4">
                              <img src="images/page-img/09.jpg" class="card-img" alt="#">
                           </div>
                           <div class="col-md-8">
