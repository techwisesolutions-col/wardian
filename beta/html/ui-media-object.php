                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active">
                        ...
                        <ul id="ui-elements" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="ui-media-object.html"><i class="las la-ad"></i>Media</a></li>
                  ...
                  <div class="col-sm-12 col-lg-6">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <div class="media mb-4">
                              <img src="images/page-img/22.jpg" class="align-self-center rounded mr-3" alt="#">
                              <div class="media-body">
                           ...
                           <div class="media">
                              <img src="images/page-img/23.jpg" class="align-self-end rounded mr-3" alt="#">
                              <div class="media-body">
