                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active">
                        ...
                        <ul id="extra-pages" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="pages-pricing-one.html"><i class="ri-price-tag-2-line"></i>Pricing 1</a></li>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-3">
                     <div class="card bg-dark text-white text-center iq-mb-3">
                        <img src="images/page-img/25.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled line-height-4 mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
                              <li>Consectetur adipiscing elit</li>
                              <li>Integer molestie lorem at massa</li>
                           ...
                           <button type="button" class="btn btn-primary mt-5">Get started</button>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-3">
                     <div class="card bg-dark text-white text-center iq-mb-3">
                        <img src="images/page-img/26.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled line-height-4 mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
                  ...
                  <div class="col-lg-3">
                     <div class="card bg-dark text-white text-center iq-mb-3">
                        <img src="images/page-img/27.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled line-height-4 mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
                  ...
                  <div class="col-lg-3">
                     <div class="card bg-dark text-white text-center iq-mb-3">
                        <img src="images/page-img/28.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled line-height-4 mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
