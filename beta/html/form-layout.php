            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active">
                        <a href="#forms" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="true"><i class="lab la-wpforms iq-arrow-left"></i><span>Forms</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        <ul id="forms" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                           <li class="active"><a href="form-layout.html"><i class="las la-book"></i>Form Elements</a></li>
                        ...
                        <div class="iq-card-body">
                           ...
                           <form>
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="color" class="form-control" id="exampleInputcolor" value="#170d82">
                              </div>
                              <div class="form-group">
